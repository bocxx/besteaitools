...
Claude Cowork is een modus binnen de Claude desktop-app waarin Claude zelfstandig meerstapsopdrachten uitvoert op je eigen computer. De motor eronder is dezelfde agent-architectuur die [Claude Code](https://www.anthropic.com/engineering/claude-code-sandboxing) aandrijft — Anthropic's terminal-tool voor developers — maar de schil is anders. Geen command line. Geen git-geneuzel. Je opent Claude, wijst een werkmap aan, en vertelt wat je wilt bereiken.
