...
De meest opvallende toevoeging is de **agentic mode**: de editor kan nu zelfstandig meerdere stappen uitvoeren, bestanden aanmaken en aanpassen, en terminalopdrachten uitvoeren — zonder dat je elke stap handmatig goedkeurt. In de bèta was dit nog experimenteel; 1.0 maakt het een eerste-klasburger. Hoe je die kracht concreet inzet om bestaande code op te schonen, laten we stap voor stap zien in [code refactoren met Cursor zonder rommel](/nieuws/cursor-code-refactoren).
