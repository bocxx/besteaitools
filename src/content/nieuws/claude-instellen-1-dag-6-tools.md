...
- Heb je je setup staan en wil je het nieuwste model gebruiken? Sinds 28 mei 2026 draait [Claude Opus 4.8 — met de 'ik weet het niet'-modus die je drie prompts laat gebruiken voor research, code-review en klantantwoorden](/nieuws/claude-opus-4-8-ik-weet-het-niet-prompts).
