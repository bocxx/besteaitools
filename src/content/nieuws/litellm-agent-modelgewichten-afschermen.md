...
Draai je je modellen lokaal, dan is [Ollama de eenvoudigste onderlaag](/nieuws/ollama-lokale-ai-modellen-draaien) onder deze opzet, en helpt [de afweging tussen Qwen zelf draaien of huren](/nieuws/qwen-3-8-27b-lokaal-draaien-of-huren) bij het kiezen van je formaat. Hoe snel AI-systemen zelf aan AI-ontwikkeling werken, staat uitgebreider beschreven in [het Anthropic-rapport over zelfbouwende AI](https://www.hetlaatsteainieuws.nl/achtergrond/anthropic-zelfverbeterende-ai-rapport) op hetlaatsteainieuws.nl.
