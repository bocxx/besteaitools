...
Wil je een AI die antwoordt op basis van jóuw documenten, en niet op basis van wat hij toevallig geleerd heeft? Dan bouw je een RAG-app. In deze gids zetten we een hybride variant op: betekenis-zoeken én trefwoord-zoeken gecombineerd, met Claude die het antwoord schrijft. Vijf stappen, één werkende opzet.
