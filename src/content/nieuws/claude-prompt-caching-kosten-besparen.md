...
heroImageAlt: "Miniatuur diorama-illustratie bij artikel 'Prompt caching bij Claude: tot 90% minder betalen voor context'"
keyTakeaways:
...
sources:
  ...
  - label: "Claude Platform Docs — Prompt caching"
...
- [Anthropic — Prompt caching (API-documentatie)](https://platform.claude.com/docs/en/build-with-claude/prompt-caching) — cache_control, breekpunten en TTL-opties
