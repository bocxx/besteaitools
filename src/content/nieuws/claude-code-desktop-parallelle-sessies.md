...
Het herontwerp is beschikbaar voor alle Claude Code-gebruikers op Pro, Max, Team en Enterprise, en via de Claude API ([Bron: Anthropic](https://claude.com/blog/claude-code-desktop-redesign)). Download de app via [claude.com/download](https://claude.com/download), of update en herstart als je hem al hebt. Je bestaande plugins werken meteen mee: de desktop-app heeft nu pariteit met de CLI, dus centraal beheerde of lokaal geïnstalleerde plugins draaien hier net als in je terminal. SSH-ondersteuning is uitgebreid naar Mac naast Linux, zodat je sessies ook op een externe machine kunt richten — wil je daar een aparte machine voor inrichten, dan laat [zo zet je een reserve-Mac op die Claude Code volledig bestuurt](/nieuws/claude-code-reserve-mac-instellen) zien hoe. Je persoonlijke configuratie reist gewoon mee: ook hooks uit `~/.claude/settings.json` — zoals [het woordfilter uit onze hooks-gids](/nieuws/claude-code-hooks-woordkeuze-aanpassen) — werken in de desktop-app net als in de terminal.

Wil je dieper in het bredere Claude Code-platform? Lees dan onze gids over [dynamische workflows in Claude Code](/nieuws/claude-code-dynamic-workflows-gebruiken) voor de grotere klussen. Draai je veel sessies naast elkaar, dan helpt [de Caveman-skill je tot 65% tokens te besparen](/nieuws/caveman-claude-code-tokens-besparen) — handig als je tegen je contextlimiet aanloopt, zeker nu [de weekly limit in Claude Code sinds 14 september 2026 17% lager ligt dan deze zomer](/nieuws/claude-code-lagere-weekly-limiet-tips). En wil je parallelle agents plus je dev-server in één venster bewaken, bekijk dan [Solo, de terminal-werkplek voor agents](/nieuws/solo-terminal-agents-een-venster). En voor context over waarom Anthropic zo zwaar investeert in het beschermen van de software-engineering en agentic reasoning capaciteiten die Claude Code onderscheiden: [Claude en de Alibaba-distillatieaanval](/nieuws/anthropic-alibaba-claude-distillatie-aanval) legt de achtergrond van die strijd uit. En voor een rustig overzicht van wat agents in 2026 eigenlijk zijn, geeft de achtergrond [AI-agents in 2026](https://www.hetlaatsteainieuws.nl/achtergrond/ai-agents-2026-wat-zijn-ze) op hetlaatsteainieuws.nl de context. Wil je een agentic sessie meteen ergens tastbaars aan wagen, probeer dan [de geanimeerde-website-workflow met Claude Code en Higgsfield](/nieuws/claude-code-higgsfield-geanimeerde-website). En gaat een sessie de verkeerde kant op, dan draai je hem terug met [/rewind en checkpoints](/nieuws/claude-code-rewind-checkpoints).
